...
<table class="table table-bordered">
        ...
        <td>
                <a href="editStock/{{$s->code}}" class="btn" title="Edit" style="background-color:lavender;"><img src="img\icons8_Edit_25px.png" /></a>
                 <!-- delete vehicle-->
              <button type="button" class="btn" title="Delete" data-toggle="modal" data-target="#myModal-{{$s->code}}" data-mytitle="{{$s->code}}"><img src="img\icons8_Trash_25px_1.png" /></button>

              <div class="modal fade" id="myModal-{{$s->code}}" role="dialog">
