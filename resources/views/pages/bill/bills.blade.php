...
<div class="container">
  <div class="row">
    <div class="col-lg-12 margin-tb">
      ...
      <!-- to search a bill using billNo or customer Name or vehicleNo-->
            ...
            <!-- Modal content-->
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <!-- return to /bills page if you don't want to delete-->  
