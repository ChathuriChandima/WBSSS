...
<div class="row">
        <div class="col-lg-12 margin-tb">
            <a href="/customers" class="btn btn-info float-left" style="margin-left:300px;"> Back</a>
        <form action="/searchCustomer" method="POST" role="search" style="margin-left:400px; margin-right:150px;">
          {{ csrf_field() }}
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <a href="editCustomer/{{$v->Id}}" class="btn" title="Edit" style="background-color:lavender;"><img src="img\icons8_Edit_25px.png" /></a>
                  ...
                  <!-- delete vehicle-->
                  <button type="button" class="btn" title="Delete" data-toggle="modal" data-target="#myModal4-{{$v->vehicleNo}}" data-mytitle="{{$v->Id}}"><img src="img\icons8_Trash_25px_1.png" /></button>
