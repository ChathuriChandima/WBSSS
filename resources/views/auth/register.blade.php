                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-left" style="color:goldenrod">{{ __('Name') }}</label>
                        ...
                        <div class="form-group row">
                                <label for="address" class="col-md-4 col-form-label text-md-left" style="color:goldenrod">{{ __('Address') }}</label>
                                <div class="col-md-6">
                                        <input type="text" class="form-control border border-warning rounded bg-dark text-light" id="address" placeholder=" ">
                                </div>
                        </div>
                        <div class="form-group row">
                                <label for="contactNo" class="col-md-4 col-form-label text-md-left" style="color:goldenrod">{{ __('Contact No') }}</label>
                                <div class="col-md-6">
                                        <input type="text" class="form-control border border-warning rounded bg-dark text-light" id="contactNo" placeholder=" ">
                                </div>
                        </div>

                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-left" style="color:goldenrod">{{ __('E-Mail Address') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-left" style="color:goldenrod">{{ __('Password') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-left" style="color:goldenrod">{{ __('Confirm Password') }}</label>
